...
class BananaRepublicSpider(scrapy.Spider):
    ...
    def start_requests(self) -> Iterable[scrapy.Request]:
        ...
        for zipcode in zipcodes:
            url = f"https://bananarepublic.gap.com/stores/maps/api/getAsyncLocations?template=search&level=search&search={zipcode}"
            yield scrapy.FormRequest(url, callback=self.parse_stores)
