...
class KumandgoSpider(scrapy.Spider):
    name = "kumandgo"
    allowed_domains = ["locations.kumandgo.com"]
    ...
    STORE_NAME_XPATH = '//span[@id="location-name"]/text()'
    ...
    HOURS_CONTAINER_XPATH = '//div[@id="hours-content"]//div[@class="c-hours-details-wrapper js-hours-table"]'
    ...
    SERVICES_XPATH = '//ul[@class="Services-cardListWrapper l-row"]/li/span/text()'
    ...
    def parse_store(self, response: Response) -> dict[str, Any]:
        ...
        try:
            parsed_store = {
                'number': response.xpath(self.STORE_NAME_XPATH).re_first(r'#KG(\d+)'),
