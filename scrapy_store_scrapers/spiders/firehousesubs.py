...
class FireHouseSubs(scrapy.Spider):
    name = "firehousesubs"
    custom_settings = dict(
        COOKIES_ENABLED=True,
    )
    headers = {
        'Host': 'use1-prod-fhs-gateway.rbictg.com',
        ...
        'Accept': '*/*',
        'Origin': 'https://www.firehousesubs.com',
    ...
    url = "https://use1-prod-fhs-gateway.rbictg.com/graphql"
    ...
    def start_requests(self) -> Iterable[Request]:
        ...
        querystring = {
            "operationName": "GetNearbyRestaurantsV2",
            "variables": "{\"input\":{\"pagination\":{\"first\":50},\"coordinates\":{\"userLat\":40.74855,\"userLng\":-73.94964},\"serviceModes\":[],\"radiusStrictMode\":true}}",
            "extensions": "{\"persistedQuery\":{\"version\":1,\"sha256Hash\":\"d9ff2cabe0e04b9e2147992e975c980e01f9446dc507cfabf591417c0bf7bc89\"}}"
        }
    ...
    def parse(self, response: Response):
        ...
        for zipcode in zipcodes:
            querystring = {
                "operationName": "GetNearbyRestaurantsV2",
                "variables": f"{{\"input\":{{\"pagination\":{{\"first\":50}},\"coordinates\":{{\"userLat\":{zipcode['latitude']},\"userLng\":{zipcode['longitude']}}},\"serviceModes\":[],\"radiusStrictMode\":true}}}}",
                "extensions": "{\"persistedQuery\":{\"version\":1,\"sha256Hash\":\"d9ff2cabe0e04b9e2147992e975c980e01f9446dc507cfabf591417c0bf7bc89\"}}"
            }
            url = self.url + "?" + urlencode(querystring)
    ...
    def parse_restaurants(self, response: Response):
        nodes = json.loads(response.text)['data']['nearbyRestaurants']['nodes']
        for node in nodes:
            yield {
                "number": node['storeId'],
                "name": node['name'],
                ...
                "url": f"https://www.firehousesubs.com/store-locator/store/{node['_id']}",
                "raw": node
            }
